...
public class DisplayShopList : MonoBehaviour
{
    ...
    public void DisplayList()
    {
        foreach (GameObject shopItem in Shop.Items)
        {
            ...
            itemListPrefab.transform.GetChild(GetLastChildIndex(itemListPrefab)).GetComponent<Button>().onClick.AddListener(() => Shop.BuyItem(itemListPrefab.transform.GetChild(0).GetComponent<TextMeshProUGUI>().text));
